...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        # ROW 1 with controls for periodo didattico
        ...
        self.btn_studenti_periodo = ft.ElevatedButton(text="Studenti Periodo",
                                                      width=200,
                                                      tooltip="Metodo per stampare gli studenti ai corsi "
        ...
        # Row 2 with controls for codice corso

        self.txt_codice_corso = ft.TextField(label="Codice corso",
                                             hint_text="Inserire codice di un corso",
                                             width=300)
        ...
        self.btn_dettaglio_corso = ft.ElevatedButton(text="Dettaglio Corso",
                                                     width=200,
                                                     tooltip="Metodo per stampare il dettaglio degli studenti "
